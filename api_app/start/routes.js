...
Route.group(() => {
  Route.resource("/aulas", "AulaController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Aula"]]));

  Route.resource("/chamadas", "ChamadaController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Chamada"]]));

  Route.resource("/turma-alunos", "TurmaAlunoController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "TurmaAluno"]]));

  Route.resource("/turmas", "TurmaController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Turma"]]));
  ...
  Route.resource("/professores", "ProfessorController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Professor"]]));

  Route.resource("/salas", "SalaController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Sala"]]));

  Route.resource("/cursos", "CursoController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Curso"]]));

  Route.resource("/disciplinas", "DisciplinaController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Disciplina"]]));

  Route.resource("/semestres", "SemestreController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Semestre"]]));

  Route.resource("/alunos", "AlunoController")
    .apiOnly()
    .validator(new Map([[["store", "update"], "Aluno"]]));
}).middleware("auth");
///}).prefix("api/v1");
